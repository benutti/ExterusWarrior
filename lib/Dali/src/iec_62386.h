...
#define DA_EXT_TERMINATE						0xA1 //Releases the INITIALISE status
#define DA_EXT_DATA_TRANSFER_REGISTER			0xA3 //Stores the data XXXX XXXX to the DTR (DTR0)
#define DA_EXT_INITIAISE						0xA5 
            /* Sets the slave to the INITIALISE status for 15 minutes. 
            Commands 259 to 270 are enabled only for a slave in this status. */
